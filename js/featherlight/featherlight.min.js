    ...
    b.prototype = {
        ...
        setup: function(b, c) {
            ...
            var d = a.extend(this, c, {
                ...
                f = a(d.background || ['<div class="' + e + "-loading " + e + '">', '<div class="' + e + '-content">', '<span class="' + e + "-close-icon " + d.namespace + '-close">', d.closeIcon, "</span>", '<span onclick="info()" id="info_hotspot" class="' + e + "-info-icon " + d.namespace + '-info">', d.infoIcon, "</span>" ,'<div class="' + d.namespace + '-inner">' + d.loading + "</div>", "</div>", "</div>"].join("")),
