...
var hatType="";
function gameHelp() {
    alert("Click on a blue letter to guess that letter. Guess correctly: the letter turns green and you are closer to earning your hat. Guess incorrectly: the letter turns red and you are closer to losing. You are allowed seven incorrect guesses.");
}
function Setup(hat) {
...
function oops() {
  gamestatus++;
  newsrc="hat-smiley" + gamestatus + ".png";
  document.images["smiley"].src=newsrc;
